...
def isolatedRun(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("OVERWINTER_SAVE_DIR", str(tmp_path / "saves"))
    monkeypatch.setenv("OVERWINTER_USAGE_REPORTING_ENABLED", "false")
...
class FakeGame:
    """Just enough of Overwinter for the engine and the people: state, a
...
def scripted(monkeypatch):
    """Build Overwinter against a ScriptedUI instead of a real front-end."""
    from overwinter import game as gameModule
    from overwinter.game import Overwinter
